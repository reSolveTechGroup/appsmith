...
public class Assets {
    ...
    public final static String GIT_DEPLOY_KEY_DOC_URL = "https://docs.resolvebuilder.com/core-concepts/version-control-with-git/connecting-to-git-repository#generating-a-deploy-key";
}
